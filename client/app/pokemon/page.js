...
function PokemonDetails() {
  ...
  return (
    <div className="bg-[#2C2C2C] h-screen flex flex-col items-center ">
      <div className="bg-[#1E1E1E] my-10 max-w-4xl w-full h-16 rounded-3xl flex justify-between px-10 py-5">
        <input
      ...
      <section className="bg-[#1E1E1E] py-12 rounded-[36px] text-white flex max-w-4xl w-full  justify-center items-center gap-14">
        <img
          className="w-[290px] "
